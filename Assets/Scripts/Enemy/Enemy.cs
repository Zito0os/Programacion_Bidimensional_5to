...
public class Enemy : MonoBehaviour
{
    ...
    public float rangoParada = 7.5f; // nueva distancia mínima: si el jugador está más cerca que esto, el enemigo se detiene
    ...
    void FixedUpdate()
    {
        ...
        if (distanciaTotal < rangoDeteccion && distanciaTotal > rangoParada) // usamos distancia total para la detección y se detiene si es <= rangoParada
        {
